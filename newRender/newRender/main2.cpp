...
//
//	if (xPos == starPositions[0][0] && yPos == starPositions[0][1]) {
//		newStar = true;
//		stars++;
//	}
//
...
//				ConsoleRendering::DrawToScreenBuffer(x, y, '#');
//			} else if (!newStar && (x == starPositions[0][0] && y == starPositions[0][1])) {
...
//	//RxPos = (float) pos;
//	starPositions[0][0] = (float) pos;
//	//RyPos = 0.0f;
//	starPositions[0][1] = 0.0f;
//	rockTwinkleAndFloat = true;
//}
//
//void moveStar () {
//	if (!rockTwinkleAndFloat) {
//		if (starPositions[0][1] == screenHeight - 1 || seeFallenStars((int) starPositions[0][0], (int) starPositions[0][1] + 1)) {
//			newStar = true;
//			//fallenRocks[fallenRockAmmount][0] = RxPos;
//			fallenRocks [fallenRockAmmount] [0] = starPositions [0] [0];
//			//fallenRocks[fallenRockAmmount][1] = RyPos;
//			fallenRocks [fallenRockAmmount] [1] = starPositions [0] [1];
//			fallenRockAmmount++;
//		}
//		//RyPos++;
//		starPositions[0][1]++;
