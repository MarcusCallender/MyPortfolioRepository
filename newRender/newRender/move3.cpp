...
//
//	if ((xPos == starPositions[fallingStars - 1][0] || xPos + 1 == starPositions[fallingStars - 1][0] || xPos - 1 == starPositions[fallingStars - 1][0]) && 
//		(yPos == starPositions[fallingStars - 1][1] || yPos + 1 == starPositions[fallingStars - 1][1] || yPos - 1 == starPositions[fallingStars - 1][1])) {
//			newStar = true;
//			stars++;
//			fallingStars--;
//	}
...
//				ConsoleRendering::DrawToScreenBuffer(x, y, '#');
//			} else if (!newStar && (x == starPositions[fallingStars - 1][0] && y == starPositions[fallingStars - 1][1])) {
...
//	if (fallingStars % 2 == 0) {
//		starTwinkleAndFloat[fallingStars - 1] = true;
//	} else {
//		starTwinkleAndFloat[fallingStars - 1] = false;
//	}
//	fallingStars++;
//}
//
//void moveStar () {
//	if (!rockTwinkleAndFloat) {
//		if (starPositions[fallingStars - 1][1] == screenHeight - 1 || seeFallenStars((int) starPositions[fallingStars - 1][0], (int) starPositions[fallingStars - 1][1] + 1)) {
//			newStar = true;
//			//fallenRocks[fallenRockAmmount][0] = RxPos;
//			fallenRocks [fallenRockAmmount] [0] = starPositions [fallingStars - 1] [0];
//			//fallenRocks[fallenRockAmmount][1] = RyPos;
//			fallenRocks [fallenRockAmmount] [1] = starPositions [fallingStars - 1] [1];
//			fallenRockAmmount++;
//			fallingStars--;
//		}
//		//RyPos++;
