...
//		//if ((player.xPos == starPositions[z][0] || player.xPos + 1 == starPositions[z][0] || player.xPos - 1 == starPositions[z][0]) && 
//		//(player.yPos == starPositions[z][1] || player.yPos + 1 == starPositions[z][1] || player.yPos - 1 == starPositions[z][1])) {
//		if ((player->xPos == movingStars[z].xPos || player.xPos + 1 == movingStars[z].xPos || player.xPos - 1 == movingStars[z].xPos) && 
//			(player.yPos == movingStars[z].yPos || player.yPos + 1 == movingStars[z].yPos || player.yPos - 1 == movingStars[z].yPos)) {
//				starsCollected++;
//				fallingStars--;
//				toSpawn[z] = true;
...
//			} else if (x == player.xPos && y == player.yPos) {
//				if (starCollected) {
//					ConsoleRendering::DrawToScreenBuffer(x, y, '@');
//				} else {
//					ConsoleRendering::DrawToScreenBuffer(x, y, player.apperance);
//				}
...
//{
//	if (IsKeyDown('D')) {
//		if (player.xPos != screenWidth - 1 && !airCollision(1)) {
...
//			} 
//
//			if (!seeFallenStars((int) player.xPos, (int) (player.yPos + 1)) && player.yPos < screenHeight - 1) {
//				grounded = false;
//			}
//		} else if (grounded && player.xPos != screenWidth - 1) {
//			goUpStep(player.xPos, player.yPos, +1);
//		}
//	} else if (IsKeyDown('A')) {
//		if (player.xPos != 0 && !airCollision(-1)) {
//			mySpeedCounter -= FRAME_DELAY_SECONDS;
//
...
//				grounded = false;
//			}
//		} else if (grounded && player.xPos != 0) {
//			goUpStep(player.xPos, player.yPos, -1);
//		}
//	}
//
...
//			grounded = false;
//			jumping = true;
//			jumpCieling = player.yPos - jumpHeight;
//		}
//	}
//
//	if (IsKeyDown('Q')) {
...
//		for (int z = 0; z < (myJumpSpeedCounter / myJumpSpeed); z++) {
//			player.yPos++;
//			if ((player.yPos == screenHeight - 1) || (seeFallenStars((int) player.xPos, (int) player.yPos + 1))) {
//				grounded = true;
...
//
//			movingStars[z].xPos = (float) pos;
//			movingStars[z].yPos = 0.0f;
//
...
//		if (z == movingStars[x].xPos && x != skip) {
//			return true;
//		}
//	}
//
...
//			if ((movingStars[z].yPos == screenHeight - 1 || seeFallenStars((int) movingStars[z].xPos, (int) movingStars[z].yPos + 1)) && (!toSpawn[z])) {
//				//fallenStars [fallenStarAmmount] [0] = starPositions [z] [0];
//				//fallenStars [fallenStarAmmount] [1] = starPositions [z] [1];
//				fallenStars [fallenStarAmmount] [0] = movingStars[z].xPos;
//				fallenStars [fallenStarAmmount] [1] = movingStars[z].yPos;
//
//				fallenStarAmmount++;
//				fallingStars--;
//				toSpawn[z] = true;
...
//	bool result = false;
//	if (!grounded && !jumping) {
//		result = seeFallenStars((int) (player.xPos + move), (int) (player.yPos + 1));
//	} else {
//		result = seeFallenStars((int) (player.xPos + move), (int) player.yPos);
//	}
//
//	return result;
//}
...
//		if (inX == movingStars[z].xPos) {
//			xMatch = true;
//		}
//
//		//if (inY == starPositions[z][1]) {
//		if (inY == movingStars[z].yPos) {
//			yMatch = true;
//		}
//
//		if (xMatch && yMatch) {
