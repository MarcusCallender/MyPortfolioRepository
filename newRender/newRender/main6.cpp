...
//const int framesPlayerChangedFor = 3;
//
//float xPos = 0.0f, yPos = screenHeight - 1, jumpCieling = 0;
////float RxPos = 0.0f, RyPos = 0.0f, rockTwinkleAndFloat = true;
//bool grounded = true, jumping = false, newStar = true, toExit = false, starCollected = false;
//int fallenRockAmmount = 0, countdown = COUNTDOWN_TIME, stars = 0, playerChangeBack = 0;
...
//
//	if (starCollected) {
//		if (playerChangeBack != framesPlayerChangedFor) {
//			playerChangeBack++;
//		} else {
//			starCollected = false;
//			playerChangeBack = 0;
